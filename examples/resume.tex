...
\quote{``Where others see impossibility, I see opportunity for innovation."}
...
% In the document body, where you want your publications to appear:
\input{resume/summary.tex}
\input{resume/experience.tex}
\input{resume/research_interests.tex}
\input{resume/publications.tex}
\input{resume/patent.tex}
